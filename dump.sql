...
INSERT INTO `cat_cliente_venta` VALUES (1,'38122677','OSCAR ARGUETA','2018-01-22 16:38:09');
...
--
-- Dumping data for table `cat_tipo_venta`
--

LOCK TABLES `cat_tipo_venta` WRITE;
/*!40000 ALTER TABLE `cat_tipo_venta` DISABLE KEYS */;
INSERT INTO `cat_tipo_venta` VALUES (1,'MERCADERIAS',1.12),(2,'SERVICIOS',0.00),(3,'EXPORTACION',0.00);
/*!40000 ALTER TABLE `cat_tipo_venta` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-01-22 12:41:46
